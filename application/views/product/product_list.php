<div class="col-md-12">
    <div class="row">
        <div class="col-md-6">
            <button type="button" id="new_prod" class='btn btn-sm btn-primary'><i class='fa fa-plus'></i> Add new product </button>
        </div>
        <hr>
    </div>
    <div id="sticky_pg">
         ...
         <div class="card mb-4 text-white bg-dark">
            ...
            <div class="card-body">
               ...
               <div class="pull-right">
              	...
              	<a href="javascript:void(0)" class="btn btn-outline-light btn-sm remove_prod" onclick="remove(this)">Delete</a>
               </div>
            </div>
         </div>
    </div>
  ...
  window.remove = function(evt){
    ...
    $(document).ready(function(){
        $('#new_prod').click(function(){
            AjaxUniModal(50,'<?php echo base_url().'popup/show_data/product/manage_product/add' ?>','Add new product menu')
        })
        load_pg();
            ...
            success:function(resp){
                if(resp){
                    ...
                    $('#list_holder .edit_prod').each(function(){
                        $(this).click(function(){
                            AjaxUniModal(50,'<?php echo base_url().'popup/show_data/product/pay_form/edit/' ?>'+$(this).attr('data-id'),'Edit Product');
                        })
                    })
                }
